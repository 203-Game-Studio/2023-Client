#ifndef SPRITE_GEN_FORWARD_LIT_PASS_INCLUDED
#define SPRITE_GEN_FORWARD_LIT_PASS_INCLUDED
...
Varyings SpriteGenVertex(Attributes input)
{
...
)
{
    ...
    half4 color = half4(inputData.normalWS, 1);
    color.a = OutputAlpha(color.a, IsSurfaceTypeTransparent(_Surface));
...
)
{
    ...
    half4 color = half4(surfaceData.metallic, surfaceData.occlusion, surfaceData.emission.r, surfaceData.smoothness);
    color.a = OutputAlpha(color.a, IsSurfaceTypeTransparent(_Surface));
