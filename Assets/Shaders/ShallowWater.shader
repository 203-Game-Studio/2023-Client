    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                half3 diffuseColor = saturate(dot(waveBlendNormal, mainLight.direction) * mainLight.color) * mainLight.shadowAttenuation;
                
                half3 specularColor = WaterSpecular(viewDir, mainLight.direction, mainLight.color, waveBlendNormal);

                half4 color = half4(diffuseColor, 1) * _BaseColor + half4(specularColor, 1);
